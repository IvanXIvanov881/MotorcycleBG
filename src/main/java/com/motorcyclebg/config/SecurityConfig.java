...
import com.motorcyclebg.service.impl.MotorcyclebgUserDetailsService;
...
public class SecurityConfig {
                ...
                .authorizeHttpRequests(
                        ...
                        authorizeRequests ->
                                authorizeRequests
                                        ...
                                        .requestMatchers("/", "/users/login", "/users/register", "/error", "/offers/all", "/offers/details/{id}", "/api/convert", "/cookies").permitAll()
    ...
    @Bean
    public MotorcyclebgUserDetailsService userDetailsService(UserRepository userRepository){
        return new MotorcyclebgUserDetailsService(userRepository);
    }
