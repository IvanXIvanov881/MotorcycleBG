insert into offers (id, brand, category, city, color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 ...
 , 'PETROL', 120, 45500, 'CBR600RR', 0894411377,  7000, 'MANUAL', 2003);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (2, 'KAWASAKI', 'NakedBike', 'Varna', 'Black/Silver', 'USED', 600, 'The Kawasaki Ninja 650R, also called ER-6f or EХ-6, is a motorcycle in the Ninja series from the Japanese
 ...
 The engine has a 180° crankshaft, resulting in an uneven firing interval of 180° and 540°.', 'PETROL', 78, 65502, 'ER-6N', 0894123321,  5000, 'MANUAL', 2006);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (3, 'YAMAHA', 'Enduro', 'Plovdiv', 'Blue/Black', 'NEW', 750, 'The Yamaha YZF-R6 is a sport bike,[1] produced by Yamaha as a 600 class from 1999 to 2020. From 2021, production availability is limited to race-only specification in most global markets,[2][3] causing race organisers to realign their engine eligibility criteria to encourage other manufacturers having larger than 600 cc displacements to enter road-race competition from 2022.[4] Race organisers wanted to provide scope for alternative machinery
 to move away from established tradition of the Yamaha R6 being the
 dominant marque in Supersport racing.[5]', 'PETROL', 78, 45502, 'YZF-R6', 0894123321,  3500, 'MANUAL', 2000);
...
insert into offer_entity_images (offer_entity_id, images) values
 ...
 insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (4, 'YAMAHA', 'Enduro', 'Ruse', 'Blue', 'USED', 250, 'The Yamaha YZF-R1, or simply R1, is a 998 cc (60.9 cu in) sports motorcycle made by Yamaha. It was first released in 1998,
 undergoing significant updates in 2000, 2002, 2004, 2006, 2007, 2009, 2015,[2] 2
 018[3] and 2020.[4]]', 'PETROL', 55, 15000, 'YZ250', 0894123321,  2000, 'AUTOMATIC', 2005);
...
insert into offer_entity_images (offer_entity_id, images) values
 ...
 insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (5, 'YAMAHA', 'NakedBike', 'Dobrich', 'Blue', 'USED', 1000, 'The Yamaha YZF-R1, or simply R1, is a 998 cc (60.9 cu in) sports motorcycle made by Yamaha. It was first released in 1998,
 undergoing significant updates in 2000, 2002, 2004, 2006, 2007, 2009, 2015,[2] 2
 018[3] and 2020.[4]]', 'PETROL', 180, 4205, 'YZF-R1', 0894123321,  4500, 'MANUAL', 2010);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (6, 'SUZUKI', 'SuperSportsBike', 'Dobrich', 'White/Red', 'USED', 750, 'The Suzuki GSX-R750 is a sports motorcycle made by Suzuki since 1984. It was introduced at the
 Cologne Motorcycle Show in October 1984 as a motorcycle of the GSX-R series for the 1985 model year.[1]', 'PETROL', 150, 55000, 'GSX-R750', 0894123321,  9000, 'MANUAL', 2015);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (7, 'HARLEYDAVIDSON', 'Chopper', 'Burgas', 'Black', 'NEW', 1250, 'A bobber, originally called a bob-job from the 1930s through 1990s, is a style of custom motorcycle. The typical construction includes removing the front fender, shortening the rear fender,
  which is "bobbed" (as in bob-tail), and stripping excess bodywork as well as all superfluous parts to reduce weight.[1][2]', 'PETROL', 45, 80000, 'Bobber', 0894123321,  20000, 'MANUAL', 2022);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (8, 'SUZUKI', 'Chopper', 'Stara Zagora', 'Yellow', 'USED', 1250, 'The Suzuki Intruder is a series of cruiser motorcycles made by Suzuki from 1985 to 2005. After 2005, the Intruder lineup was replaced by the Boulevard range.
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (9, 'HONDA', 'SuperSportsBike', 'Veliko Turnovo', 'Yellow/Black', 'USED', 599, 'The Honda CBR600RR is a 599 cc (36.6 cu in) sport bike made by Honda since 2003,
 part of the CBR series. The CBR600RR was marketed as Hondas top-of-the-line middleweight sport bike, succeeding the
 2002 Supersport World Champion 2001–2006 CBR600F4i, which was then repositioned as the tamer,
 more street-oriented sport bike behind the technically more advanced and uncompromising race-replica CBR600RR.
 It carried the Supersport World Championship winning streak into 2003, and on through 2008, and won in 2010 and 2014.'
 , 'PETROL', 120, 45500, 'CB500', 0894123321,  7000, 'MANUAL', 2003);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (10, 'KAWASAKI', 'NakedBike', 'Varna',  'Black/Silver', 'USED', 600, 'The Kawasaki Ninja 650R, also called ER-6f or EХ-6, is a motorcycle in the Ninja series from the Japanese
 manufacturer Kawasaki Motors sold since 2006. In 2012, the R suffix was dropped from its name.[2] It is a middleweight, parallel-twin engined motorcycle,
 designed for normal use on paved roads. They have modern styling and features, with low-seating ergonomics and a low center of gravity.
 The engine has a 180° crankshaft, resulting in an uneven firing interval of 180° and 540°.', 'PETROL', 78, 65502, 'ER-6N', 0894123321,  5000, 'MANUAL', 2006);
...
insert into offer_entity_images (offer_entity_id, images) values
 ...
 insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (12, 'YAMAHA', 'NakedBike', 'Dobrich', 'Blue', 'USED', 1000, 'The Yamaha YZF-R1, or simply R1, is a 998 cc (60.9 cu in) sports motorcycle made by Yamaha. It was first released in 1998,
 undergoing significant updates in 2000, 2002, 2004, 2006, 2007, 2009, 2015,[2] 2
 018[3] and 2020.[4]]', 'PETROL', 180, 4205, 'YZF-R1', 0894123321,  4500, 'MANUAL', 2010);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (13, 'SUZUKI', 'SuperSportsBike', 'Pernik', 'White/Red', 'USED', 750, 'The Suzuki GSX-R750 is a sports motorcycle made by Suzuki since 1984. It was introduced at the
 Cologne Motorcycle Show in October 1984 as a motorcycle of the GSX-R series for the 1985 model year.[1]', 'PETROL', 150, 55000, 'GSX-R750', 0894123321,  9000, 'MANUAL', 2015);
...
insert into offers (id, brand, category, city,  color, condition_type, cubic_centimeters, description, engine, hp, mileage, model, phone, price, transmission, year) values
 (14, 'HARLEYDAVIDSON', 'Chopper', 'Vidin', 'Black', 'NEW', 1250, 'A bobber, originally called a bob-job from the 1930s through 1990s, is a style of custom motorcycle. The typical construction includes removing the front fender, shortening the rear fender,
  which is "bobbed" (as in bob-tail), and stripping excess bodywork as well as all superfluous parts to reduce weight.[1][2]', 'PETROL', 45, 80000, 'Bobber', 0894123321, 20000, 'MANUAL', 2022);
...
insert into equipment (id, city, equipment_brand, equipment_condition_type, equipment_description, equipment_price, equipment_type, phone) values
(2, 'Dobrich', 'Alpinestars', 'USED', 'Alpinestars is an Italian motorsports and action sports safety equipment manufacturer based in Asolo, Italy. Its lines include specialized products for MotoGP, motocross, motorcycling, Formula One, World Rally Championship, WEC, V8 Supercars, NASCAR, mountain biking, and surfing, and motorsports-themed,
non-sports clothing, with fashion design centers in Italy and California offering products for men, women and kids.[1]', 300, 'MotorcycleSuits', 0894411377);
...
insert into equipment (id, city, equipment_brand, equipment_condition_type, equipment_description, equipment_price, equipment_type, phone) values
(3, 'Dobrich', 'AGV', 'USED', 'AGV (initials for "Amisano Gino Valenza") is an Italian motorcycle helmet manufacturer active in motorcycle sport. Founded in 1947 by Gino Amisano, since 2007 the company is a subsidiary of Dainese,[1]
...
insert into equipment (id, city, equipment_brand, equipment_condition_type, equipment_description, equipment_price, equipment_type, phone) values
(4, 'Dobrich', 'Dainese', 'NEW', 'Dainese (pronounced dye-ee-neh-zeh; Italian: [daiˈneze]) is an Italian manufacturer of protective equipment and technical gear for dynamic sports, including motorcycling, mountain biking, winter sports and horseriding.
Founded in 1972 by Lino Dainese, it has expanded through organic growth and acquisitions, including Italian helmet manufacturer AGV in 2007.[1]', 450, 'MCJacketsShirtsHoodies', 0894411377);
...
insert into equipment (id, city, equipment_brand, equipment_condition_type, equipment_description, equipment_price, equipment_type, phone) values
(5, 'Dobrich', 'Alpinestars', 'USED', 'Alpinestars is an Italian motorsports and action sports safety equipment manufacturer based in Asolo, Italy. Its lines include specialized products for MotoGP, motocross, motorcycling, Formula One, World Rally Championship, WEC, V8 Supercars, NASCAR, mountain biking, and surfing, and motorsports-themed,
non-sports clothing, with fashion design centers in Italy and California offering products for men, women and kids.[1]', 300, 'MotorcycleSuits', 0894411377);
...
insert into equipment (id, city, equipment_brand, equipment_condition_type, equipment_description, equipment_price, equipment_type, phone) values
(6, 'Dobrich', 'AGV', 'USED', 'AGV (initials for "Amisano Gino Valenza") is an Italian motorcycle helmet manufacturer active in motorcycle sport. Founded in 1947 by Gino Amisano, since 2007 the company is a subsidiary of Dainese,[1]
which was taken over by Investcorp in 2019.[2] The AGV brand is well known in motorcycle sport.', 1200, 'Helmets', 0894411377);
...
Motorcycle engines are typically two-stroke or four-stroke internal combustion engines,
 but other engine types, such as Wankels and electric motors, have been used.', 650, 'EnginePartsFilters', 0894411377);
